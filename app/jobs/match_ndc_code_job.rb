class MatchNdcCodeJob
  ...
  def perform
    ...
    # RawFile.where(ndc: all_ndc_codes, bin: all_bin, state: all_states, pcn:all_pcn).in_batches.update_all(matched_ndc_bin_pcn_state: true)
    # RawFile.where(ndc: all_ndc_codes, bin: all_bin, pcn:all_pcn).in_batches.update_all(matched_ndc_bin_pcn: true)
    # RawFile.where(ndc: all_ndc_codes, bin: all_bin).in_batches.update_all(matched_ndc_bin: true)
